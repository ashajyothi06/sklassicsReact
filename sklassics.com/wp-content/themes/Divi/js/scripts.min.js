                        ...
                        if (window.et_calculate_fullscreen_section_size = function() {
                                ...
                                n.et_pb_simple_carousel = function(t, e) {
                                    ...
                                    if ((E.length || d.isBuilder) && (window.set_gallery_grid_items = function(t) {
                                            ...
                                            t.closest(".et_pb_column_3_8").length || t.closest(".et_pb_column_1_4").length || t.children(".et_pb_countdown_timer_container").width() <= 400 ? (t.find(".days .label").text(t.find(".days").data("short")), t.find(".hours .label").text(t.find(".hours").data("short")), t.find(".minutes .label").text(t.find(".minutes").data("short")), t.find(".seconds .label").text(t.find(".seconds").data("short"))) : (t.find(".days .label").text(t.find(".days").data("full")), t.find(".hours .label").text(t.find(".hours").data("full")), t.find(".minutes .label").text(t.find(".minutes").data("full")), t.find(".seconds .label").text(t.find(".seconds").data("full")))
